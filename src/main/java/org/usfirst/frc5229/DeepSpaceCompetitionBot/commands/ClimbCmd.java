...
public class ClimbCmd extends Command {
    ...
    protected void execute() {
        if (Robot.oi.driveController.getRawButton(1)) {
            Robot.climbSub.climber(true, false, false);
        }
        else if (Robot.oi.driveController.getRawButton(2)) {
            Robot.climbSub.climber(false, true, false);
        }
        else {
            Robot.climbSub.climber(false, false, true);
        }

        if (Robot.oi.driveController.getRawButton(3)) {
            Robot.climbSub.ClimbWheels(1);
        }
        else if (Robot.oi.driveController.getRawButton(4)) {
            Robot.climbSub.ClimbWheels(-1);
        }
        else {
            Robot.climbSub.ClimbWheels(0);
        }
    }
